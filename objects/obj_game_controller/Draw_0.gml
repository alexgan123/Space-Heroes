...
draw_text_custom(260, 50, string(hp) + " Health", font_small, c_white, fa_center, fa_middle);
draw_text_custom(260, 120, string(attack) + " Attack", font_small, c_white, fa_center, fa_middle);
draw_text_custom(260, 190, string(defense) + " Defense", font_small, c_white, fa_center, fa_middle);